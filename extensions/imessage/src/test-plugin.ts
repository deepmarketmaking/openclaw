import { collectStatusIssuesFromLastError } from "openclaw/plugin-sdk/channel-status";
import type { ChannelOutboundAdapter, ChannelPlugin } from "openclaw/plugin-sdk/core";
